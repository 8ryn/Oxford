...
dirtag=RFG_${batchtag}; nrepeat=10; for ii in $(echo targetC_beamel*.txt )
do
...
cd ${dir}
    ...
    job1="$myeWro/bin/nuwro -i ${parfile} -o out_${dirtag}.root > see_${dirtag}.log"
    echo \$job1
    eval \$job1
